...
// Load static route references after response.js has fully initialized, avoiding circular imports.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (adminWithdrawalDecisionMatch) { req.query.id = adminWithdrawalDecisionMatch[1]; req.body = { ...(req.body || {}), status: adminWithdrawalDecisionMatch[2] === 'approve' ? 'APPROVED' : 'REJECTED' }; return await loadHandler('../server/admin/withdrawals/[id]/decision')(req, res); }
